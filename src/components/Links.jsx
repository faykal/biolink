...
const links = [
  { title: "Personal Website", description: "About me.", url: "https://personal.faykalbotz.my.id", icon: "🌐" },
  ...
  { title: "Noxxy AI", description: "make all questions easier with ai.", url: "https://ai.faykalbotz.my.id", icon: "🪐" },
